...
// Found in: resources\views\auth\forgot-password.blade.php, resources\views\emails\reset_password.blade.php, resources\views\emails\thankyouforyourorder.blade.php, resources\views\emails\verify-email.blade.php, resources\views\emails\welcome.blade.php, resources\views\errors\error-404.blade.php, resources\views\landing\landing.blade.php, resources\views\layouts\app.blade.php, resources\views\layouts\footer.blade.php, resources\views\user\codex.blade.php, resources\views\user\edit-book.blade.php, resources\views\user\my-books.blade.php, resources\views\user\privacy.blade.php, resources\views\user\showcase-library.blade.php, resources\views\user\stories.blade.php, resources\views\user\terms.blade.php, resources\views\welcome.blade.php
		'Write Books With AI' => 'Yapay Zeka ile Kitap Yazın',
...
// Found in: resources\views\auth\forgot-password.blade.php, resources\views\auth\login.blade.php, resources\views\auth\register.blade.php, resources\views\emails\welcome.blade.php, resources\views\errors\error-404.blade.php, resources\views\landing\landing.blade.php, resources\views\layouts\app.blade.php, resources\views\paypal\paypal-finish-page.blade.php, resources\views\user\my-books.blade.php, resources\views\user\showcase-library.blade.php, resources\views\user\stories.blade.php
		'Your Story, Our AI - Write Books Faster, Smarter, Better with AI' => 'Senin Hikayen, Bizim Yapay Zekamız - Yapay Zeka ile Kitapları Daha Hızlı, Daha Akıllı, Daha İyi Yazın',
...
// Found in: resources\views\user\all-beats.blade.php
		'Write Books With AI - Book Beats' => 'Yapay Zeka ile Kitap Yazın - Kitap Vuruşları',
...
// Found in: resources\views\user\all-beats.blade.php
		...
		'Rewrite Beat Description' => 'Vuruş Açıklamasını Yeniden Yaz',
		'Text' => 'Metin',
		'Summary' => 'Özet',
		'Beat Description' => 'Vuruş Açıklaması',
		'Beat Text' => 'Vuruş Metni',
		'Beat Summary' => 'Vuruş Özeti',
...
// Found in: resources\views\user\all-beats.blade.php
		...
		'Writing beat summary...' => 'Vuruş özeti yazılıyor...',
		'Beat summary generated successfully!' => 'Vuruş özeti başarıyla oluşturuldu!',
		'Failed to write summary: ' => 'Özet yazılamadı: ',
		'Failed to write beat summary.' => 'Vuruş özeti yazılamadı.',
...
// Found in: resources\views\user\book-details.blade.php
		...
		'Generated Cover' => 'Oluşturulan Kapak',
		'Generate' => 'Oluştur',
		'An image describing: ' => 'Şunu betimleyen bir resim: ',
...
// Found in: resources\views\user\edit-book.blade.php
		...
		'Rewritten Chapter:' => 'Yeniden Yazılan Bölüm:',
		'Accept Rewrite' => 'Yeniden Yazımı Kabul Et',
		'Chapter saved successfully!' => 'Bölüm başarıyla kaydedildi!',
		'Failed to save chapter: ' => 'Bölüm kaydedilemedi: ',
		'An error occurred while saving the chapter.' => 'Bölüm kaydedilirken bir hata oluştu.',
		'This process will write 10 short beats for each chapter in the book. Later these beats will be turned into full book pages.' => 'Bu işlem, kitaptaki her bölüm için 10 kısa vuruş yazacak. Daha sonra bu vuruşlar tam kitap sayfalarına dönüştürülecek.',
		...
		'Failed to rewrite chapter:' => 'Bölüm yeniden yazılamadı:',
		'Error rewriting chapter' => 'Bölüm yeniden yazılırken hata oluştu',
		'Chapter rewritten successfully!' => 'Bölüm başarıyla yeniden yazıldı!',
		'Failed to save rewritten chapter:' => 'Yeniden yazılan bölüm kaydedilemedi:',
...
// Found in: resources\views\user\settings.blade.php
		...
		'We are sad to see you go, but we hope that Write Books With AI has been an enjoyable experience for you. We wish you the best in your future endeavors. Goodbye!' => 'Gitmenize üzülüyoruz, ancak Write Books With AI\'ın sizin için keyifli bir deneyim olduğunu umuyoruz. Gelecekteki çalışmalarınızda size en iyisini diliyoruz. Hoşça kalın!',
...
// Found in: resources\views\user\start-writing.blade.php
		...
		'the_1_act_story.txt' => 'tek_perdeli_hikaye.txt',
		'The 1 Act Story (1 Act, 3 Chapters)' => 'Tek Perdeli Hikaye (1 Perde, 3 Bölüm)',
		'abcde_short_story.txt' => 'abcde_kisa_hikaye.txt',
		'ABCDE (1 Acts, 6 Chapters)' => 'ABCDE (1 Perde, 6 Bölüm)',
		...
		'Click here to edit the book.' => 'Kitabı düzenlemek için buraya tıklayın.',
		...
		'&copy; 2024 writebookswithai.com All rights reserved.' => '&copy; 2024 writebookswithai.com Tüm hakları saklıdır.',
