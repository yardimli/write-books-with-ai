function passwordStrengthMeter(opts) {
    ...
    ${opts.containerElement} .password-strength-meter-score.psms-20 {width: 20%; background: ${opts.colorScore1 || '#ff7700'};}
    ${opts.containerElement} .password-strength-meter-score.psms-40 {width: 40%; background: ${opts.colorScore2 || '#ffff00'};}
    ${opts.containerElement} .password-strength-meter-score.psms-60 {width: 60%; background: ${opts.colorScore3 || '#aeff00'};}
    ${opts.containerElement} .password-strength-meter-score.psms-80 {width: 80%; background: ${opts.colorScore4 || '#00ff00'};}
